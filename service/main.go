...
// project Address
//https://consummate-yew-176018.appspot.com
//ID: consummate-yew-176018
...
const (
	...
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID = "consummate-yew-176018"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://34.209.75.24:9200"
)
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	//}
	//
	//fmt.Print("Search received: %f %f %s", lat, lon, ran)
	//
	//// Return a fake post
	//p := &Post{
	//	User:"1111",
